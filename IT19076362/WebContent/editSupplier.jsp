...
<body>
	...
	<!-- Start content section -->
      ...
      <div class="form-container" style="margin-left: 15rem;">
         <h1 class="title">Edit Details <span style="font-size: 1rem;">  SUPPLIER</span></h1>
         <form method="POST" action="EditSupplierServlet" class="reg-form">
            ...
            <br>
            <input class="input service" type="text" name="service" placeholder="New Service" maxlength="50" required>
            <br>
