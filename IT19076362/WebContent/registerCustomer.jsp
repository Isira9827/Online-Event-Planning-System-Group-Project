...
<body>
	...
	<!-- Start content section -->
      ...
      <div class="form-container">
         <h1 class="title">REGISTER <span style="font-size: 1rem;">  AS CUSTOMER</span></h1>
         <form method="POST" action="AddCustomerServlet" class="reg-form">
            ...
            <br>
            <input class="input interest" type="text" name="interest" placeholder="Interested Events ?" maxlength="50" required>
            <br>
